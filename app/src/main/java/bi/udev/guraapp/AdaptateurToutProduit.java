...
class AdaptateurToutProduit extends RecyclerView.Adapter<AdaptateurToutProduit.ViewHolder>{

    Context context;
    ArrayList<Produit> produits;
    Utilisateur user;

    public AdaptateurToutProduit(Context context, ArrayList<Produit> produits, Utilisateur utilisateur) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, DetailsProduits.class);
                intent.putExtra("titre", produits.get(position).titre);
                intent.putExtra("prix", produits.get(position).prix);
                intent.putExtra("photo", produits.get(position).photo);
                intent.putExtra("vendeur", produits.get(position).vendeur);
                intent.putExtra("slug", produits.get(position).slug);
                intent.putExtra("details", produits.get(position).detail);
